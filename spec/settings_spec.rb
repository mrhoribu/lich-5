  ...
  describe "Ruby Compatibility" do
    ...
    describe "Conversion Methods" do
      it "handles to_hash and to_h methods" do
        ...
        puts("to_hash Lich::Common::Settings[:test_hash].to_hash: #{Lich::Common::Settings[:test_hash].to_hash}")
        puts("to_hash Lich::Common::Settings[:test_hash].instance_variable_get(:@target).to_hash: #{Lich::Common::Settings[:test_hash].instance_variable_get(:@target).to_hash}")
        puts("to_hash Lich::Common::Settings[:test_hash].to_h: #{Lich::Common::Settings[:test_hash].to_h}")
        puts("to_hash Lich::Common::Settings[:test_hash].instance_variable_get(:@target).to_h: #{Lich::Common::Settings[:test_hash].instance_variable_get(:@target).to_h}")
